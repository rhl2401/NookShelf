    ...
    case "json":
      return new Response(bundleToJson(EXAMPLE_BUNDLE), {
        headers: {
          ...
          "Content-Disposition": `attachment; filename="nookshelf-example.json"`,
        },
      });
    case "csv": {
      ...
      return new Response(new Uint8Array(zip), {
        headers: {
          ...
          "Content-Disposition": `attachment; filename="nookshelf-example-csv.zip"`,
        },
      });
    }
    case "xlsx": {
      ...
      return new Response(new Uint8Array(xlsx), {
        headers: {
          ...
          "Content-Disposition": `attachment; filename="nookshelf-example.xlsx"`,
        },
      });
    }
    default:
